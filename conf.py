...
BLOG_AUTHOR = "Adam John Miller"  # (translatable)
BLOG_TITLE = "maxamillion.sh"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://maxamillion.sh/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://maxamillion.sh/"
BLOG_EMAIL = "maxamillion@fedoraproject.org"
BLOG_DESCRIPTION = "A moderately sophisticated shellscript in the meatspace operating system of life."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS feed"),
        ("https://maxamillion.sh/resume", "Resume"),
    ),
}
...
#        ('https://fedoraproject.org/wiki/User:Maxamillion', 'About me', 'icon-user'),
#        ('https://twitter.com/TheMaxamillion', 'My Twitter', 'icon-twitter'),
#        ('https://github.com/maxamillion', 'My Github', 'icon-github'),
#    )
#}
#THEME = "zen"
